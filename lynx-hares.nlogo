...
to eat-plants
  if pcolor = green and energy < 100
  [
    set pcolor brown
    set energy energy + grass-energy-gain
  ]
end
...
to go
  ...
  ask patches [
    ifelse growth >= grass-regrowth-time
    [
      set growth 0
      set pcolor green
    ]
    [
      if pcolor = brown and random 100 < grass-regrowth-chance
      [
        set growth growth + 1
      ]
    ]
